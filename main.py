...
def k_nearest(dimensions, k, point, current_node, priority_queue=[], depth=0):
    ...
    if current_node.left == None and current_node.right == None:
        ...
        priority_queue = k_nearest(dimensions, k, point, current_node.right, priority_queue, depth)
        priority_queue = k_nearest(dimensions, k, point, current_node.left, priority_queue, depth)
...
pq = k_nearest(getDimensions(point_list), 3, point, tree)
